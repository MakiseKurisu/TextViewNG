...
#define DEF_PROGRESSBAR_POSITION    0x00000001
#define DEF_PROGRESSBAR_TIME        0x00000002
#define DEF_PROGRESSBAR_AS_DELAY    0x00000004
#define DEF_PROGRESSBAR_BATTERY     0x00000008
#define DEF_PROGRESSBAR_TOP         0x00000010
#define DEF_PROGRESSBAR_CHAPTER     0x00000020
#define DEF_PROGRESSBAR (DEF_PROGRESSBAR_TIME | DEF_PROGRESSBAR_BATTERY | DEF_PROGRESSBAR_TOP)
